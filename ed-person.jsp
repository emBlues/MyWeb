...
<html>
    <head>
        ...
        <style>
        	...
        	#pic2{position: relative;left: 210px;bottom: 100px;border: solid darkblue;border-radius: 50%}
        	#subPic{position: absolute;left: 400px;top: 180px;}
	...
	<%@include file="ed-head.jsp"%>
    	<div class="pic1">
    		<form id="subPic" action="#" method="post" enctype="multipart/form-data">
    			...
    			<input type="submit" value="上传头像" onclick="subHeadPic()"class=new>
    			<input type="submit" value="上传背景" onclick="subBgPic()"class=new>
    		</form>
