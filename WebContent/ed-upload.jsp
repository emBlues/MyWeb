...
<html style="height:100%;">
	...
	<head>
		...
		<style>
			body {background:url("pic/bg1.jpg") no-repeat;background-size:100% 100%;padding: 0;margin: 0;}
			...
			.left {width:400px;height:580px; float: left;margin-top: 60px;margin-left: 20px; opacity:0.7;}
			...
			.right {width:850px;height:580px;margin-top: 60px; float:left;opacity:0.7;}
